...
\begin{itemize}
    ...
    \item \textbf{Dane wzbogacone o predykcję stanu (Augmented Data with Predicted Status)} - oryginalne dane sensoryczne wzbogacone o sklasyfikowany stan urządzenia, generowane przez moduł \textit{\mbox{EquipmentStateProcessor}} z użyciem modelu \textit{\mbox{RandomForestClassifier}}:
    \begin{itemize}
        ...
        \item \textit{model\_type} - typ modelu użytego do predykcji (tutaj: \textit{\mbox{RandomForestClassifier}}).
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{predykcję ogólnego stanu technicznego} monitorowanego urządzenia na podstawie połączonych informacji z wielu sensorów, przy użyciu modelu \textit{\mbox{RandomForestClassifier}} (moduł \textit{\mbox{EquipmentStateProcessor}}),
