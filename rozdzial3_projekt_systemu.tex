...
\begin{lstlisting}[language=JSON, caption=Model raportów w Elasticsearch]
    {
        "properties": {
                "id": {
                    "type": "keyword"
...
\begin{lstlisting}[language=JSON, caption=Analizatory i normalizatory w Elasticsearch]
    {
        "analysis": {
          "normalizer": {
