...
\begin{figure}[h]
    \centering
    % Tutaj powinien być diagram architektury systemu
...
\begin{figure}[h]
    \centering
    % Tutaj powinien być diagram modelu danych
...
Użytkownicy i uprawnienia są modelowane jako:
...
\begin{figure}[h]
    \centering
    % Tutaj powinien być diagram przepływu danych
