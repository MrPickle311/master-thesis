...
W klastrze Kubernetes działa mikroserwis \textit{SQS-Kafka-Forwarder}, regularnie odpytujący kolejki kolejki SQS i pobierający nowe wiadomości. Wiadomości te są następnie deserializowane i publikowane na odpowiednie kanały (ang. \textit{topics}) brokera Kafki, w zależności od typu czujnika i lokalizacji.
