...
W badaniach wykorzystano dane symulowane, generowane przez funkcje AWS Lambda (usługa obliczeniowa firmy Amazon Web Services pozwalająca na uruchamianie kodu bez konieczności zarządzania serwerami) \cite{aws_lambda_docs}.
