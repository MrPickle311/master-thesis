...
W dobie czwartej rewolucji przemysłowej (Przemysł 4.0) i Internetu Rzeczy (IoT) \cite{przemysl40_iot_ogolnie}, systemy wieloczujnikowe stają się nieodłącznym % TODO: User to verify/replace 'przemysl40_iot_ogolnie' with a specific key from bibl.tex or add a new entry
