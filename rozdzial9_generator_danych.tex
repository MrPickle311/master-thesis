...
\begin{itemize}
    ...
    \item $\texttt{hash}(\cdot)$ - funkcja haszująca,
...
\begin{enumerate}
    ...
    \item obliczenie postępu: $progress = \texttt{min}(1.0, t_{stan} / t_{trwania}),$ gdzie $t_{trwania}$ to całkowity czas trwania stanu,
