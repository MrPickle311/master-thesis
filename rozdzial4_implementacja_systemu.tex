...
\begin{itemize}
    ...
    \item \textbf{język \textit{Scala}} - język programowania wykorzystany do implementacji aplikacji \\ \textit{\mbox{SparkDataProcessor}} służącej do przetwarzania strumieni danych za pomocą \mbox{Apache Spark},
...
\begin{itemize}
    ...
    \item \textbf{menedżer pakietów \textit{Helm 3}} - menedżer pakietów dla Kubernetes,
